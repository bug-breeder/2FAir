  ...
  const plans = [
    {
      ...
      limitations: ["Limited to 20 codes"],
      cta: "Get Started Free",
      popular: false,
      color: "default",
      gradient:
        "from-default-100/80 to-default-200/80 dark:from-default-800/30 dark:to-default-900/30",
    },
    {
      name: "Pro",
      price: "$3",
      ...
      color: "primary",
      gradient:
        "from-primary-100/50 to-secondary-100/50 dark:from-primary-900/20 dark:to-secondary-900/20",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Absolutely! Your codes are protected with end-to-end encryption, meaning they're encrypted on your device before being stored. We use the same security standards as banks, and even we can't see your codes.",
    },
    {
      question: "Can I switch from other 2FA apps?",
      answer:
        "Yes! You can easily import your existing codes by scanning QR codes or uploading screenshots from apps like Google Authenticator, Authy, and others.",
    },
    {
      question: "What if I lose my phone?",
      answer:
        "No worries! Your codes are safely backed up in the cloud with end-to-end encryption. Just log in on a new device and everything will be there.",
    },
    {
      question: "Can I cancel anytime?",
      answer:
        "Of course! Cancel anytime with one click. No questions asked, no hidden fees. You can even downgrade to the free plan and keep using 2FAir.",
    },
    {
      question: "Do you offer discounts?",
      answer:
        "We offer discounts for students, nonprofits, and annual payments. Contact us and we'll see what we can do!",
    },
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Start free and upgrade when you need more. All plans include
            ...
            >
              {[
                ...
                >
                  <Icon className={badge.color} icon={badge.icon} width={16} />
              ...
              {[
                {
                  ...
                  description:
                    "Your codes are encrypted on your device before storage. Even if our servers are breached, your data stays safe.",
                ...
                },
                {
                  ...
                  title: "No Passwords",
                  description:
                    "Use your fingerprint, face, or security key. Faster and more secure than any password.",
                ...
                },
                {
                  ...
                  description:
                    "Phone, tablet, computer - your codes sync automatically across all your devices.",
                ...
                },
                {
                  ...
                  description:
                    "Secure backup with end-to-end encryption means you'll never be locked out, even if you lose your phone.",
                ...
                },
                {
                  ...
                  description:
                    "Bank-level security meets consumer simplicity. Trusted by individuals and teams worldwide.",
                ...
                },
                {
                  ...
                  description:
                    "Get your codes in seconds, not minutes. No more hunting through different apps.",
        ...
        <section className="py-20 bg-gradient-to-r from-primary-50/40 via-secondary-50/30 to-primary-50/40 dark:from-primary-950/20 dark:via-secondary-950/15 dark:to-primary-950/20 relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-4xl px-6 text-center relative z-10">
            ...
            >
              ...
              >
                Ready to make your digital life easier? It&apos;s time to
                upgrade to 2FAir Pro.
              </motion.h2>
              <motion.p
              ...
              >
                Join thousands of people who've made their accounts more secure
                and easier to manage with end-to-end encrypted 2FAir.
              </motion.p>
