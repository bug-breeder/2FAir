...
func (a *authService) HandleOAuthCallback(provider string, code string, state string) (*infraServices.OAuthProvider, error) {
...
func (a *authService) RegisterOrLoginUser(ctx context.Context, oauthData *infraServices.OAuthProvider) (*entities.User, error) {
...
func (a *authService) GenerateJWT(user *entities.User) (string, error) {
	...
	claims := &infraServices.JWTClaims{
...
func (a *authService) ValidateJWT(tokenString string) (*infraServices.JWTClaims, error) {
	...
	return &infraServices.JWTClaims{
		UserID:    userID,
		Username:  username,
		Email:     email,
...
func (a *authService) RefreshJWT(tokenString string) (string, error) {
	...
	newClaims := &infraServices.JWTClaims{
