...
func NewOTPService(otpRepo interfaces.OTPRepository, cryptoService infraServices.CryptoService, totpService infraServices.TOTPService) infraServices.OTPService {
	return &otpService{
		otpRepo:       otpRepo,
